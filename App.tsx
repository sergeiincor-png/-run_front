...
const BlogSection: React.FC = () => {
  const articles: Article[] = [
    ...
    },
    {
      ...
      readTime: '5 мин',
      image: 'https://images.unsplash.com/photo-1507398941214-57f516d901ca?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 3,
      ...
      category: 'Здоровье',
      readTime: '8 мин',
      image: 'https://images.unsplash.com/photo-1571011234237-4b245f512408?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 4,
      ...
      category: 'Экипировка',
      readTime: '7 мин',
      image: 'https://images.unsplash.com/photo-1478720568477-151d9b147283?auto=format&fit=crop&q=80&w=800'
    },
    {
      id: 5,
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {articles.map((article, index) => (
            ...
            >
              <div className="relative aspect-[16/10] rounded-[2rem] overflow-hidden mb-6 shadow-2xl">
                <img 
                  src={article.image} 
                  alt={article.title} 
